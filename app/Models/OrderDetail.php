...
class OrderDetail extends Model
{
    ...
    public function batteryProduct()
    {
        return $this->belongsTo(Battery::class, 'product_id');
    }

    public function tyreProduct()
    {
        return $this->belongsTo(Tyre::class, 'product_id');
    }

    public function petrolProduct()
    {
        return $this->belongsTo(Petrol::class, 'product_id');
    }
    public function carwashProduct()
    {
        return $this->belongsTo(CarWashProduct::class,'product_id');
    }
}
