                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <img v-bind:src="'https://carkee.my/public/uploads/all/PDlvp1gGXHjyiGTeWvqwoUFlJDaZAsfngDqnvI1X.png'"
                                        style="width: 250px;" class="img-fluid mb-3">
                                </div>
                                <div class="form-group">
                                            ...
                                            <tr>
                                                <td class="border-2px">
                                                    ...
                                                    <p class="mb-1"><strong>Contact Person</strong>: {{ order.pic_name
                                                        }} ({{order.pic_name && order.pic_phone ? order.pic_phone :
                                                        '-'}})</p>
                                ...
                                <div class="form-group">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr class="border-tr-2px" v-for="(item, index) in order_items"
                                                    :key="item.id">
                                                    <td>{{ index + 1 }}</td>
                                                    <td>-</td>
                                                    <td>{{ item.name }}</td>
