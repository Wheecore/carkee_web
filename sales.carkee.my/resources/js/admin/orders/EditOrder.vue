                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <span class="text-danger"> *</span>
                                    <select :class="['form-control', {'is-invalid': payment_term_error}]" name="payment_term" v-model="payment_term" disabled>
                                        <option value="">-- Choose --</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-4">
                                    ...
                                    <select data-live-search="true" :class="['form-control products-select', {'is-invalid': products_error}]" v-model="selected_products" ref="select" multiple>
                                        <option v-for="option in products" :key="option.id" :value="option.id" :data-amount="option.amount" :data-disc="option.disc">
                                            {{ option.name }}
                                        </option>
                                    </select>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr v-for="(row, index) in rows" :key="index" :id="row.id">
                                                ...
                                                <td width="10%"><input type="number" class="form-control" @input="updateQuantity" :data-key="row.id" :id="'qty-' + row.id" v-model="row.qty" /></td>
                                                ...
                                                <td width="10%"><input type="number" step="0.01" class="form-control" v-model="row.amount" /></td>
