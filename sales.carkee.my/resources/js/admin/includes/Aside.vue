    ...
    <div class="sidebar">
        ...
        <div class="sidebar-body">
            <nav class="nav-sidebar">
                ...
                <router-link to="/admin/inventory" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#25396f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <router-link to="/admin/credit-notes" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#25396f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
