...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function onScanSuccess(qrMessage) {
            var result = qrMessage.split(': ');
            var second_part = result[1];
            var result2 = second_part.split('User');
            window.location.href = "{{ url('merchant/voucher/check')}}"+'/'+result2[0]+'/'+result[2];
        }
