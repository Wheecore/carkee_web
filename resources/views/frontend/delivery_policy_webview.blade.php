...
<body>
    @php
        $delivery_policy = \App\Models\Page::where('type', 'delivery_policy_page')->first();
    @endphp
    <section class="pt-4 mb-4 mt-5">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-12 text-center text-lg-left">
                    <h1 class="fw-600 h4">{{ $delivery_policy->getTranslation('title') }}</h1>
                </div>
            </div>
        </div>
    </section>
    <section class="mb-4">
        <div class="container">
            <div class="p-4 bg-white rounded shadow-sm overflow-hidden mw-100 text-left">
                @php
                    echo $delivery_policy->getTranslation('content');
                @endphp
            </div>
        </div>
    </section>
