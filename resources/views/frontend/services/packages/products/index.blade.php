...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div>
                <select name="package_id" id="package_id" class="form-control" onchange="InProducts()">
...
@section('script')
    ...
    <script>
        function InProducts() {
            ...
            $.ajax({
                url : "{{ url('admin/add-package-products') }}",
                type: 'get',
                data: {
                ...
                {
                    AIZ.plugins.notify('success', '{{ translate('Products Package Updated successfully') }}');
                },
                error: function()
                {
                    alert('failed...');
