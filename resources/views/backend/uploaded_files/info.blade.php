<div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" value="{{ convert_datetime_to_local_timezone($file->created_at, user_timezone(Auth::id())) }}" disabled>
    </div>
    <div class="form-group text-center">
        ...
        <a class="btn btn-secondary" href="{{ my_asset($file->file_name) }}" target="_blank"
            download="{{ $file_name }}.{{ $file->extension }}">{{ translate('Download') }}</a>
    </div>
</div>
