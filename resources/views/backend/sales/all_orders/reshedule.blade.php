                    ...
                    <table class="table aiz-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th data-breakpoints="md">{{ translate('Workshop') }}</th>
                                <th data-breakpoints="md">{{ translate('Appointment Date') }}</th>
                                <th data-breakpoints="md">{{ translate('Approved By Workshop') }}</th>
                        ...
                        <tbody>
                            @foreach ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td>
                                        {{ convert_datetime_to_local_timezone($order->created_at, user_timezone(Auth::id())) }}
                                    </td>
                                    <td>
                                        {{ $order->model_name }}
                                    </td>
                                    ...
                                    <td>
                                        {{ $order->workshop_date_approve_status == 1 ? 'Yes' : 'No' }}
                                    </td>
                                    @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                        <td>
