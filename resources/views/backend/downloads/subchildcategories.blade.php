	...
	<style media="all">
		...
		*{
		...
		<div style="padding: 1.5rem;">
			<table class="padding small border-bottom">
				<thead>
					<tr class="gry-color" style="background: #eceff4;">
						<th class="text-left">{{translate('Sub Category ID') }}</th>
						<th class="text-left">{{translate('Child Category ID') }}</th>
						<th class="text-left">{{translate('Child Category Name') }}</th>
					</tr>
				</thead>
				<tbody class="strong">
