...
@section('content')
    <div class="card">
        <div class="card-header">
            <h6 class="fw-600 mb-0">{{ translate('Website Footer Widget') }}</h6>
        </div>
        <div class="card-body">
                            ...
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('Address') }}"
                                        name="contact_address" value="{{ get_setting('contact_address') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Widget title"
                                        name="widget_one" value="{{ get_setting('widget_one') }}">
                                </div>
                                <div class="form-group">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ json_decode(App\BusinessSetting::where('type', 'widget_one_links')->first()->value, true)[$key] }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-auto">
                                                        <button type="button"
