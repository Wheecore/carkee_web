...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-10 mx-auto">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Tyre Page Banners') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            {{-- /////product details page banners --}}

            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Product page promotion banners (Max 3)') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="home-banner6-target">
                                <input type="hidden" name="types[]" value="home_banner6_images">
                                <input type="hidden" name="types[]" value="home_banner6_links">
                                @if (get_setting('home_banner6_images') != null)
                                    @foreach (json_decode(get_setting('home_banner6_images'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <div class="form-control file-amount">
                                                            {{ translate('Choose File') }}</div>
                                                        <input type="hidden" name="types[]" value="home_banner6_images">
                                                        <input type="hidden" name="home_banner6_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_banner6_images'), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_banner6_links">
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        name="home_banner6_links[]"
                                                        value="{{ json_decode(get_setting('home_banner6_links'), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-md-auto">
                                                <div class="form-group">
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="home_banner6_images">
											<input type="hidden" name="home_banner6_images[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_banner6_links">
										<input type="text" class="form-control" placeholder="http://" name="home_banner6_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
