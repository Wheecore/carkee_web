...
@section('content')
    ...
    <div class="row gutters-5">
        <div class="col-lg-9 mx-auto">
            <form class="form form-horizontal mar-top" action="{{ route('add-tyre-battery-part.store') }}"
                ...
                <div class="row add-new-product">
                    <div class="col-md-12">
                        <ul class="nav nav-pills mb-3 d-block text-center" id="pills-tab" role="tablist">
                            ...
                            <!--<li class="nav-item d-inline-block" role="presentation">-->
                            <!--    <a class="nav-link" id="pills-part-tab" data-toggle="pill" href="#pills-part"-->
                            <!--        role="tab" aria-controls="pills-part" aria-selected="false">-->
                            <!--        {{ translate('Part') }}-->
                            <!--    </a>-->
                            <!--</li>-->
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-tyre" role="tabpanel" aria-labelledby="pills-tyre-tab">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <option value="">--Select--</option>
                                        <option value="front/rear">All</option>
                            ...
                            <div class="tab-pane fade" id="pills-part" role="tabpanel" aria-labelledby="pills-part-tab">
                                ...
                                <div class="row text-right">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-md btn-info btn-part-filter"
                                                onclick="get_all_parts()">
                                                {{ translate('Filter Products') }}
                                                <div class="spinner-border d-none" role="status"></div>
                                            </button>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mb-0 h6">{{ translate('Part Information') }}</h5>
                                    </div>
                                    <div class="card-body">
                                        <div>
                                            <div class="row mb-3">
