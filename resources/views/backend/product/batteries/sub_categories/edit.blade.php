        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header row gutters-5">
                    ...
                    <a class="btn btn-primary" href="{{ route('battery-sub-categories.index') }}"><i class="las la-arrow-left mr-1"></i>Back</a>
                </div>
                <div class="card-body p-0">
                    <form class="p-4" action="{{ route('battery-sub-categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
