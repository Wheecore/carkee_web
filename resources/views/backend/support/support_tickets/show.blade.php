...
@section('content')
@php $timezone = user_timezone(Auth::id()); @endphp
    <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header row gutters-5">
                <div class="text-center text-md-left">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="ml-2"> {{ convert_datetime_to_local_timezone($ticket->created_at, $timezone) }} </span>
            ...
            <div class="card-body">
                <form action="{{ route('support_ticket.admin_store') }}" method="post" id="ticket-reply-form"
                    ...
                    <div class="form-group mb-0 text-right">
                        ...
                        <button type="submit" class="btn btn-icon btn-sm btn-dark" id="dropdownMenuButton"
                            data-toggle="dropdown" aria-haspopup="true"><i class="las la-angle-down"></i></button>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#"
                                onclick="submit_reply('open')">{{ translate('Submit as') }}
                                <strong>{{ translate('Open') }}</strong></a>
                            <a class="dropdown-item" href="#"
                                onclick="submit_reply('solved')">{{ translate('Submit as') }}
                                <strong>{{ translate('Solved') }}</strong></a>
                        </div>
                    </div>
                </form>
                <div class="pad-top">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="">
                                            ...
                                            <p class="text-muted text-sm fs-11">{{ convert_datetime_to_local_timezone($ticketreply->created_at, $timezone) }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                                        ...
                                        @foreach (explode(',', $ticketreply->files) as $key => $file)
                                            ...
                                            @if ($file_detail != null)
                                                <a href="{{ uploaded_asset($file) }}" download=""
                                                    ...
                                                    <i
                                                        class="las la-paperclip mr-2">{{ $file_detail->file_original_name . '.' . $file_detail->extension }}</i>
                                                </a>
                                            @endif
                                        @endforeach
                                    </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="comment-header">
                                        ...
                                        <p class="text-muted text-sm fs-11">{{ convert_datetime_to_local_timezone($ticket->created_at, $timezone) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                @foreach (explode(',', $ticket->files) as $key => $file)
                                    ...
                                    @if ($file_detail != null)
                                        <a href="{{ uploaded_asset($file) }}" download=""
                                            class="badge badge-lg badge-inline badge-light mb-1">
                                            <i
                                                class="las la-download text-muted">{{ $file_detail->file_original_name . '.' . $file_detail->extension }}</i>
                                        </a>
                                        <br>
                                    @endif
                                @endforeach
