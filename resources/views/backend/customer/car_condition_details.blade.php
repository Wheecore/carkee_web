...
@section('title', translate('Customer Car Condition List Details'))
@section('content')

    @if (isset($sort_by_red))
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{ translate('Customer Car Condition List Details') }}</h5>
                <a class="btn btn-primary" href="{{ route('customer.car.condition') }}"><i class="las la-arrow-left mr-1"></i>Back</a>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="row">
                            ...
                            <h5 style="font-weight: 700">GUIDE FOR INTERIOR / EXTERIOR, UNDER HOOD, UNDER VEHICLE, BRAKE
                                CONDITION </h5>

                            <div class="row">
                                <div class="col-3">
                                    <div style="height:30px;width: 30px;background:green;border:1px solid blue"></div>
                                    <b>CHECKED AND OK AT THIS TIME</b>
                                </div>
                                <div class="col-3">
                                    <div style="height:30px;width: 30px;background:yellow;border:1px solid blue"></div>
                                    <b>MAY NEED FUTURE ATTENTION</b>
                                </div>
                                <div class="col-3">
                                    <div style="height:30px;width: 30px;background:red;border:1px solid blue"></div>
                                    <b>REQUIRES IMMEDIATE ATTENTION</b>
                                </div>
                                <div class="col-3">
                                    <div style="height:30px;width: 30px;background:white;border:1px solid blue"></div><b>NOT
                                        INSPECTED</b>
                                </div>
                            </div>
                            ...
                            @if ($condition->headlights == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Headlights / Turn Signals / High Beams / Fog Lights :
                                    </strong></div>
                                <div class="col-6 mt-2">
                            ...
                            @if ($condition->tail_lights == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Tail Lights / Brake Lights / Turn Signals / Reverse Lights :
                                    </strong></div>
                                <div class="col-6 mt-2">
                            ...
                            @if ($condition->engine_oil == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->engine_oil }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->coolant == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->coolant }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->power == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->power }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->brake_fluid == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->brake_fluid }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->windscreen == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->windscreen }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->automatic == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->automatic }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->cooling_system == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->cooling_system }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->radiator_case == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->radiator_case }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->engine_air == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->engine_air }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            ...
                            @if ($condition->front_shocks == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Front Shocks / Suspension / Stabalizer / Bushes : </strong>
                                </div>
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->front_shocks }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->drivershaft == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->drivershaft }}; height:30px; width:30px"></div>
                                </div>
                            @endif
                            @if ($condition->subframe == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Subframe / Steering System / Tie Rods : </strong></div>
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->subframe }}; height:30px; width:30px"></div>
                                </div>
                            @endif
                            @if ($condition->fluid_leaks == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Fluid Leaks (oil / Transmission / Coolant) : </strong>
                                </div>
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->fluid_leaks }}; height:30px; width:30px"></div>
                                </div>
                            @endif
                            @if ($condition->brake_hose == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Brake Hose / Linings / Cables : </strong></div>
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->brake_hose }}; height:30px; width:30px"></div>
                                </div>
                            @endif
                            @if ($condition->real_shocks == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Rear Shocks / Suspension / Stabalizer / Bushes : </strong>
                                </div>
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->real_shocks }}; height:30px; width:30px"></div>
                                </div>
                            @endif
                            @if ($condition->differential == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Differential / Axle (check Condition & Leaks) : </strong>
                                </div>
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->differential }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            @if ($condition->exhuast == $sort_by_red)
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->exhuast }}; height:30px; width:30px"></div>
                                </div>
                            @endif
                            @if ($condition->wheel_bearing == $sort_by_red)
                                <div class="col-6 mt-2"><strong>Wheel Bearings / Sensors / Harness : </strong></div>
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->wheel_bearing }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            <div class="col-6 mt-2"><strong>Comment : </strong></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-2">
                                @foreach ($photos as $key => $photo)
                                    <img style="height:165px; width: 46%;margin-bottom: 4px;" class=""
                            ...
                            @if ($condition->battery_terminals == $sort_by_red)
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div style="height:30px;width: 30px;background:white;border:1px solid blue"></div>
                                        <b>NOT INSPECTED</b>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mt-2">
                                    <div style="background: {{ $condition->battery_terminals }}; height:30px; width:30px">
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div style="height:30px;width: 30px;background:red;border:1px solid blue"></div><b>2MM
                                        or LESS</b>
                                </div>
                                <div class="col-6">
                                    <div style="height:30px;width: 30px;background:white;border:1px solid blue"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->horn_operation }}; height:30px; width:30px;border:1px solid blue">
                                </div>

                            </div>
                            <div class="col-6 mt-2"><strong>Headlights / Turn Signals / High Beams / Fog Lights : </strong>
                            </div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->headlights }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Front Wiper Blades : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->front_wiper_blades }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Rear Wiper Blade : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->rear_wiper_blade }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Tail Lights / Brake Lights / Turn Signals / Reverse Lights :
                                </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->tail_lights }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>In-cabin Icrofilter / Interior Lights : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->in_cabin }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>System Check Lights / Faulty Massages : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->system_check_lights }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong> Comment: </strong></div>
                            <div class="col-6 mt-2">{{ $condition->interior_comment }}</div>
                            ...
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->engine_oil }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Coolant : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->coolant }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Power Steering Fluid : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->power }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Brake Fluid : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->brake_fluid }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Windscreen Washer Fluid : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->windscreen }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Automatic Transmission Fluid : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->automatic }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Cooling System Hoses / Parts : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->cooling_system }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Radiator Case / Core / Cap : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->radiator_case }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Engine Air Filter : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->engine_air }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Drive Belts : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->driver_belt }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Comment : </strong></div>
                            <div class="col-6 mt-2">{{ $condition->under_hood_comment }}</div>
                            ...
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->front_shocks }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Driveshaft / Cv Boots : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->drivershaft }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Subframe / Steering System / Tie Rods : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->subframe }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Fluid Leaks (oil / Transmission / Coolant) : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->fluid_leaks }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Brake Hose / Linings / Cables : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->brake_hose }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Rear Shocks / Suspension / Stabalizer / Bushes : </strong>
                            </div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->real_shocks }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Differential / Axle (check Condition & Leaks) : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->differential }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Exhuast / Muffler / Mountings : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->exhuast }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Wheel Bearings / Sensors / Harness : </strong></div>
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->wheel_bearing }}; height:30px; width:30px;border:1px solid blue">
                                </div>
                            </div>
                            <div class="col-6 mt-2"><strong>Comment : </strong></div>
                            <div class="col-6 mt-2">{{ $condition->under_vehicle_comment }}</div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-6 mt-2">
                                <div
                                    style="background: {{ $condition->battery_terminals }}; height:30px; width:30px;border:1px solid blue;border:1px solid blue">
                                </div>
                            </div>
