...
@section('title', translate('Tyre Orders'))
@section('content')
    ...
    <div class="card">
        <form class="" action="" id="sort_orders" method="GET">
            <div class="card-header row gutters-5">
                <div class="col">
                    <h5 class="mb-md-0 h6">{{ translate('Tyre Orders') }}</h5>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        ...
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                            href="{{ route('tyre_orders.show', encrypt($order->id)) }}"
                                            title="{{ translate('View') }}">
                                            <i class="las la-eye"></i>
                                        </a>
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                            href="{{ route('invoice.emergency-order', ['order_id' => $order->id, 'type' => 'tyre']) }}"
