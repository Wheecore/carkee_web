...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a class="btn btn-primary" href="{{ route('tyre_orders.index') }}"><i class="las la-arrow-left mr-1"></i>Back</a>
        </div>
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($orderDetail->tyreProduct != null)
                                            <strong><a href="#"
                                                    class="text-muted">{{ $orderDetail->tyreProduct->name }}</a></strong>
                                        @else
            ...
            <div class="clearfix float-right">
                ...
                <div class="text-right no-print">
                    <a href="{{ route('invoice.emergency-order', ['order_id' => $order->id, 'type' => 'tyre']) }}"
