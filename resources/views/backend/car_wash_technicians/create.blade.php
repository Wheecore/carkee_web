...
@section('title', translate('Add Car Wash Technician'))
@section('content')
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('car-wash-technicians.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"
                                placeholder="{{ translate('Contact No') }}" name="phone" value="" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control autocomplete" id="autocomplete"
                                placeholder="Pandamaran, 41200 Klang" name="address" required>
                        </div>
                    </div>
                    <div class="form-group row">
