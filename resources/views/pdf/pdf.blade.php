...
<body style="background-color: #fff; font-family: system-ui;">
    ...
    <table table align="center" cellpadding="0" cellspacing="0" style="color: #000; width: 100%; padding-top: 40px;">
      <tbody>
        <tr>
          <td style="text-align: right; vertical-align: bottom;">
            <a style="font-size: 18px;" href="{{ route('do-order.update', ['order_id' => $order->id]) }}">
              Click here to complete and receive the order.
            </a>
          </td>
        </tr>
      </tbody>
