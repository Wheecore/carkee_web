...
!function (e) {
    ...
    t.prototype = {
        constructor: t, _initializeOptions: function (t) {
            ...
            s.addClass("las la-chevron-left"), a.append(s), n.append(a);
            ...
            r.addClass("year-title current_year"), r.text(this.options.startYear), n.append(r);
            ...
            c.addClass("las la-chevron-right"), u.append(c), n.append(u), t.append(n), this.element.append(t)
            ...
            for (var a = 0; 12 > a; a++) {
                ...
                var checkbox = e(document.createElement("input"));
                checkbox.attr("type","checkbox");
                checkbox.addClass("month-checkbox");
                checkbox.attr("name","month[]");
                checkbox.attr("value",n[this.options.language].months[a]);
                var i = new Date(this.options.startYear, a, 1), o = e(document.createElement("table"));
                o.addClass("month");
                var r = e(document.createElement("thead")), d = e(document.createElement("tr")),
                    l = e(document.createElement("th"));
                l.addClass("month-title"), l.attr("colspan", this.options.displayWeekNumber ? 8 : 7), l.text(n[this.options.language].months[a]), d.append(l), r.append(d), s.append(checkbox);
                ...
                for (; g >= p;) {
                    ...
                    do {
                        ...
                        if (y.addClass("day"), i > p) y.addClass("old"); else if (p > g) y.addClass("new"); else {
                            ...
                            v.addClass("day-content"), v.attr("date",p.getDate()), v.attr("month",n[this.options.language].months[a]), v.text(p.getDate()), y.append(v), this.options.customDayRenderer && this.options.customDayRenderer(v, p)
                        }
            ...
            null != this.options.dataSource && this.options.dataSource.length > 0 && this.element.find(".month-container").each(function () {
                var n = e(this).data("month-id"), a = new Date(t.options.startYear, n, 1),
            ...
            this.element.find(".year-neighbor, .year-neighbor2").click(function () {
                ...
                e(this).hasClass("disabled") || t.element.find(".months-container").animate({"margin-left": "100%"}, 100, function () {
                    t.element.find(".months-container").hide(), t.element.find(".months-container").css("margin-left", "0"), setTimeout(function () {
                        ...
                        var year = t.options.startYear - 1;
                        getYearTiming(year);
                    }, 50)
                })
            ...
            n.click(function (n) {
                ...
                var n = e(t.element).width(), a = e(t.element).find(".month").first().width() + 10,
                    s = "month-container";
            ...
            for (var i in s) {
                ...
                d.addClass("las la-chevron-right"), o.append(d), this._renderContextMenuItems(o, this.options.contextMenuItems, s[i]), n.append(o)
            }
            ...
            for (var i in n) if (!n[i].visible || n[i].visible(a)) {
                ...
                var d = e(document.createElement("span"));
                d.addClass("las la-chevron-right"), o.append(d), n[i].items && n[i].items.length > 0 && this._renderContextMenuItems(o, n[i].items, a), s.append(o)
            }
            ...
            var t = e.children(".day-content").text(), n = e.closest(".month-container").data("month-id"),
